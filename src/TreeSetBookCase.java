...
public class TreeSetBookCase {
    ...
    public MyDataBase dataBase = new MyDataBase();
     ...
     */
    public synchronized String doCommand(Command command) {
        ...
        /*if (command.getCommand().compareTo("qwe") == 0){
            List<Recipe> q = new ArrayList<>();
            message = this.add(new RecipeBook("fromQwe", q, new Human("kek"), 123, 321));
            return message;
        }*/
    ...
    public String showTreeSetAsString(ConcurrentSkipListSet<RecipeBook> treeSet) {
        String result = "";
        for (Object r : this.treeSet.stream().sorted(Comparator.comparing(RecipeBook::getName)).toArray()) {
            result += r.toString() + "\n";
        }
        return result;
    }
...
recipes
Recipe, name salad4, ingredients tomato brokoly, description mix it, result bad salad, likes -2
Recipe, name salad4, ingredients tomato brokoly, description mix it, result very bad salad, likes -12
xCoordinate 11
yCoordinate 54
date 2019-06-09T13:15:32.420858500+04:00[Europe/Samara]
                 */