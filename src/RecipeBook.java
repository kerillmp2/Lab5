...
public class RecipeBook extends Thing implements Readable, Serializable {
    ...
    public RecipeBook(String name, String ownerName, int ownerAge, String Recipes, int x, int y, String date) {
        this();
        this.setName(name);
        this.setOwner(new Human(ownerName, ownerAge));
        this.xCoordinate = x;
        this.yCoordinate = y;
    ...
    public RecipeBook(String name, List<Recipe> recipes, Human owner, int xCoordinate, int yCoordinate) {
        ...
        this.xCoordinate = xCoordinate;
        this.yCoordinate = yCoordinate;
        this.dateOfCreation = ZonedDateTime.now().toString();
    }
